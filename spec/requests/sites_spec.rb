...
RSpec.describe "/sites", type: :request do
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Site" do
        expect {
          post sites_url,
               params: { site: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Site" do
        expect {
          post sites_url,
               params: { site: invalid_attributes }, as: :json
        }.to change(Site, :count).by(0)
      end

      it "renders a JSON response with errors for the new site" do
        post sites_url,
             params: { site: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested site" do
        site = Site.create! valid_attributes
        patch site_url(site),
              params: { site: new_attributes }, headers: valid_headers, as: :json
        site.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested site" do
      site = Site.create! valid_attributes
      expect {
        delete site_url(site), headers: valid_headers, as: :json
      }.to change(Site, :count).by(-1)
    end
  end
end
